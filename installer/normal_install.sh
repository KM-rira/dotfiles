...
packages=(gh git-delta dust tlrc glances glow yazi lazygit lazydocker cheat bat luarocks zoxide jq fd ripgrep fzf zoxide shfmt duf node npm chrony vim sd eza)
