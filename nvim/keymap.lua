...
vim.keymap.set({'n', 'x', 'o'}, '<leader>f', builtin.find_files, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>g', builtin.live_grep, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>b', builtin.buffers, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>o', builtin.oldfiles, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>c', builtin.commands, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>h', builtin.command_history, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>j', builtin.jumplist, {})
vim.keymap.set({'n', 'x', 'o'}, '<leader>s', builtin.search_history, {})
vim.keymap.set({'n', 'x', 'o'}, "<leader>z", "<Cmd>Telescope frecency<CR>")
