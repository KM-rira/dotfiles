...
vim.keymap.set({'n', 'o'}, 'd ', 'diw', { noremap = true, silent = true })
vim.keymap.set({'n', 'o'}, 'c ', 'ciw', { noremap = true, silent = true })
vim.keymap.set({'n', 'o'}, 'y ', 'yiw', { noremap = true, silent = true })
vim.keymap.set({'n', 'o'}, 'gu ', 'guiw', { noremap = true, silent = true })
vim.keymap.set({'n', 'o'}, 'gU ', 'gUiw', { noremap = true, silent = true })
-- insert mode setting
