...
alias restores="cd $(git rev-parse --show-toplevel); git restore --staged; cd -"
alias restoresf="bash ~/vimConf/tools/restoresf.sh"
alias restoresa="cd $(git rev-parse --show-toplevel); git restore --staged .; cd -"
alias add="cd $(git rev-parse --show-toplevel); git add; cd -"
alias addf="bash ~/vimConf/tools/addf.sh"
alias adda="cd $(git rev-parse --show-toplevel); git add .; cd -"
